...
def configure_callbacks(callbacks,
  ...
  if hasattr(callback_list.model, 'stop_training'):
    print(f"\n----- PRE callbacks.configure_callbacks is now {callback_list.model.stop_training}, no se modifica\n")
    #callback_list.model.stop_training = False
  else:
    print(f"\n----- stop_training no existe, lo ponemos en False\n")
    callback_list.model.stop_training = False
